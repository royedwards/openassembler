...
class NodeType02:
    ...
    def BasicShape02(self,InputParameters):
        ...
        n=1
        while n<=len(Input):
                    TargetCanvas.create_rectangle(x,y+n*30,x+7,y+n*30+20,fill=BaseColorTop,width=1,outline="black",tag=(str(ID),str(ID)+Input[n-1][0],Input[n-1][0],"IN",NodeUpperLabel+"select"))
