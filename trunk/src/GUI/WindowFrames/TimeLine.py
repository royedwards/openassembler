...
class CanvasInitTimeLine(NodeEditorCanvasEvents):
    ...
    def timeLine_init(self,TargetCanvas,editorcanvas):
        ...
        o= Button(timelineFrame,width=2,highlightcolor="gray35",bd=1,height=0,padx=0,pady=0,highlightbackground="gray35",text="<-",font=iofont)
        ...
        o2=onefor=Button(timelineFrame,width=2,highlightcolor="gray35",bd=1,height=0,padx=0,pady=0,highlightbackground="gray35",text=">>",font=iofont)
